...
// EVENTO AGGIUNGI MEMBRO BONUS
addBtn.addEventListener('click', function(){
    let addName = document.querySelector('#name').value;
    let addRole = document.querySelector('#role').value;
    let addPhoto = document.querySelector('#role').value;
    ourTeam.length ++;

    let newArr = ourTeam.length;
    ...
    addMemberFunc (newArr, addName, addRole, addPhoto);

    memberCardFunc (newArr); 
